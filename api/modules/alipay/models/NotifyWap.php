...
use common\components\wapalipay\Md5;
use Yii;
use common\components\wapalipay\Functions;
use common\components\wapalipay\Rsa;
class NotifyWap {
    /**
     * HTTPS形式消息验证地址
     */
    ...
    public function getResponse($notify_id) {
        ...
        $responseTxt = Functions::getHttpResponseGET($veryfy_url, $this->alipay_config['cacert']);
    ...
    public function getSignVeryfy($para_temp, $sign, $isSort) {
        //除去待签名参数数组中的空值和签名参数
        $para = Functions::paraFilter($para_temp);
        ...
        $prestr = Functions::createLinkstring($para);
