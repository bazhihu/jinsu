...
class WorkerotherController extends Controller
{
    ...
    /**
     * Lists all Workerother models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new WorkerotherSearch;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())){
          //  echo '1';
           ...
           // $params = $params_all['Workerother'];
//var_dump($params_all);
            //die();
            //foreach($params['ext1_1'] as $key=>$value){
                //echo "<p>".$value;
            //}
    ...
    {
        if (($model = Workerother::findOne($id)) !== null) {
            return $model;
        } else {
