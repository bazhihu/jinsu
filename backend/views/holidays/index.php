 ...
 * @var backend\models\HolidaysSearch $searchModel
 */
...
<div class="holidays-index">
    ...
    <p>
        <?php /* echo Html::a('Create Holidays', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['holidays/view','id' => $model->id,'edit'=>'t']), [
