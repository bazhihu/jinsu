...
<?php \yii\bootstrap\Modal::begin([
    'header' => '<strong>添加请假信息</strong>',
    'id'=>'addLeaveModal',
    'size'=>'modal-lg',
]);?>
<div id="addLeaveModalContent">加载中...</div>
<?php \yii\bootstrap\Modal::end();?>
...
<script>
    ...
    /*$('body').on('click', 'button.jsLeaveCreate', function () {
        var url = $(this).attr('data-url');
        $("#addLeaveModalContent").load(url);
        $('#addLeaveModal').modal({"show":true});
    });*/
</script>