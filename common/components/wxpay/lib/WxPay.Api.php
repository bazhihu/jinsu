...
require_once WEB_ROOT."/common/components/wxpay/lib/WxPay.Config.php";
require_once WEB_ROOT."/common/components/wxpay/lib/WxPay.Exception.php";
require_once WEB_ROOT."/common/components/wxpay/lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		//$url = "http://uat.m.youaiyihu.com/my/wxpayapi/curl.php";
		//检测必填参数
